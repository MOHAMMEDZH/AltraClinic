...
import type { PlatformPlansAuditLog, PlatformPlansAuditRecord } from '../application/ports/plan-audit-log.port';
...
@Injectable()
export class AuditTrailPlatformPlansAuditLog implements PlatformPlansAuditLog {
