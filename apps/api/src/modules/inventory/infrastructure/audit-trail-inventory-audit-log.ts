...
@Injectable()
export class AuditTrailInventoryAuditLog implements InventoryAuditLog {
  ...
  private async writeAudit(
    ...
    const actorRoles = entry.actorRoles?.length > 0 ? entry.actorRoles : ['inventory'];
