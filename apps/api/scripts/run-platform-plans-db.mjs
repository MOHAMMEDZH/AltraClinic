#!/usr/bin/env node
/**
 * Runs Step 13 Platform Plans PostgreSQL integration suites.
 */
...
const result = spawnSync(
  ...
  [
    ...
    apiRoot,
    '--testPathPattern',
    'platform-plans(\\.|-)(?!entitlements).*postgres\\.integration\\.spec\\.ts$|platform-plans\\.postgres\\.integration\\.spec\\.ts$|platform-plans-evidence\\.postgres|platform-plans-final-gate\\.postgres',
  ],
