#!/usr/bin/env node
/** Flexible Step 27 — Notifications and Templates PostgreSQL suites. */
...
console.log(
  'Step 27 runner: N01–N24 + TW01–TW16 + L01–L16 + I/R/T/A/F/C/H/P matrices + query/index + window.util (realExternalDeliveriesDuringTests=0)',
);
...
const patternArgs = extraArgs.some((a) => a.startsWith('--testPathPattern'))
  ? []
  : ['--testPathPattern', 'platform-notifications/.*\\.spec\\.ts$'];
