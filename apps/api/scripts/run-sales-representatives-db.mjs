#!/usr/bin/env node
/** Flexible Step 23 — Sales Representative Management PostgreSQL suites. */
...
console.log(
  'Step 23 runner: A01-A16 audit cardinality + S01-S16 grantability denials + M01-M08 manager rules + C01-C24 concurrency + F01-F30 failure injection + H01-H48 HTTP passport',
);
...
const result = spawnSync(
  ...
  [
    ...
    apiRoot,
    '--testPathPattern',
    'platform-sales-representatives/.*\\.spec\\.ts$',
  ],
