#!/usr/bin/env node
/**
 * Runs Step 14 Platform Plan Entitlements PostgreSQL integration suites.
 */
...
const result = spawnSync(
  ...
  [
    ...
    apiRoot,
    '--testPathPattern',
    'platform-plan-entitlements(\\.|-final-gate|-closure|-concurrent-idempotency)?\\.postgres\\.integration\\.spec\\.ts$',
  ],
