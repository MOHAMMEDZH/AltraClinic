...
export const SETTINGS_NAV: SettingsNavItem[] = [
  ...
  { id: 'clinical-services', to: '/settings/clinical-services', labelKey: 'settings.nav.clinicalServices', descriptionKey: 'settings.nav.clinicalServicesDesc', groupKey: 'settings.nav.groupClinic', resourceId: 'api.clinical-catalog', requiredAction: 'view', keywords: ['clinical', 'procedure', 'service', 'catalog'] },
