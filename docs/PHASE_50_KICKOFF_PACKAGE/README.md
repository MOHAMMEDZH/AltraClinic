...
| **Status** | **D0 kickoff only**; Phase 50 PA = **PENDING**; implementation slices **NOT STARTED**; Phase 51 **NOT AUTHORIZED** |
...
Phase 50 implementation slices = NOT AUTHORIZED by this package alone
