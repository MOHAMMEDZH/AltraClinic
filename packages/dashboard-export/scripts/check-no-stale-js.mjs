...
if (stale.length > 0) {
  console.error('Stale compiled artifacts detected under packages/dashboard-export/src:');
...
console.log('dashboard-export source check passed (no stale .js/.d.ts under src/)');
